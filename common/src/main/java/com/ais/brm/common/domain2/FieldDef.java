...
public class FieldDef {
    ...
    public Object getValue(ResultSet rs) throws SQLException {
        switch (this.getType()) {
            ...
            case NUMERIC:
                return rs.getBigDecimal(this.fieldName);
            ...
            case BYTES:
                return rs.getBytes(this.fieldName);
            case DATE:
                return rs.getDate(this.fieldName);
            case TIME:
                return rs.getTime(this.fieldName);
            case TIMESTAMP:
                return rs.getTimestamp(this.fieldName);
        }
