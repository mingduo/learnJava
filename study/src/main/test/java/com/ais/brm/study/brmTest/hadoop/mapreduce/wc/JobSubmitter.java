...
import com.ais.brm.study.hadoop.wc.WordcountMapper;
import com.ais.brm.study.hadoop.wc.WordcountReducer;
...
public class JobSubmitter {
  ...
  //  private final static String HDFS_NAME = "hdfs://10.21.20.220:9000";
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.set("fs.defaultFS", HDFS_NAME);
        // 2、设置job提交到哪去运行
        conf.set("mapreduce.framework.name", "yarn");
        conf.set("yarn.resourcemanager.hostname", "192.168.16.131");
        ...
        // 1、封装参数：jar包所在的位置
        job.setJar("E:/dtwork/learnJava/learn/learnJava/study/target/study-1.0-SNAPSHOT.jar");
        ...
        FileSystem fs = FileSystem.get(new URI(HDFS_NAME), conf, "root");
        if (fs.exists(output)) {
