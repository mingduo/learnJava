...
public class Constants {
    ...
    public static final int DEFAULT_BATCH_DETAILER_THREADPOOL_SIZE = 10;//used by GeneralDetailer
    ...
    //发起监控请求
    public static final String TOPIC_NOTIF_MONITOR_START = "TOPIC_NOTIF_MONITOR_START";
   //	监听TOPIC_MON_ SCAN_NOW消息，执行立即扫描任务
    public static final String TOPIC_MON_SCAN_NOW="TOPIC_MON_SCAN_NOW";
    ...
    public static final String TOPIC_INDEX_RESULT = "TOPIC_INDEX_RESULT";//指标入库请求
    public static final String TOPIC_RISK_INDEX_CHANGED = "TOPIC_RISK_INDEX_CHANGED"; //指标变更通知
    ...
    public static final int KAFKA_NOTIF_TYPE_RISKINDEX_SAVE = 19;//指标保存
    public static final int KAFKA_NOTIF_INDEX_CHANGE = 20;//指标变更通知
    public static final int KAFKA_NOTIF_ALERT = 21;//统一告警通知
    //一键查询
    public static final int KAFKA_NOTIF_TYPE_KEYQUERY = 22;
    ...
    public static final String ELASTICSEARCH_DATASOURCE_TYPE_ID = "000007";//es数据源
    ...
    public static final String PREFIX_MODEL_CODE = "M_";//模型编码开头.

    //告警
    public static final String TOPIC_ALERTS = "topic-alerts";
    //一键查询后台处理
    public static final String TOPIC_ONEKEY_QUERY = "TOPIC_ONEKEY_QUERY";
  ...
  //指标采集周期
    ...
    //指标now更新周期
    public static final String REDIS_KEY_FOR_RISKINDEXSAVER = "RiskIndexSaver";
    public static final String REDIS_FLAG_FOR_RISKINDEXSAVER = "RiskIndexSaverFlag";
    //es index,type
    public static final String ES_INDEX_FOR_INDEX_RESULT_INFO = "risk_index_result_db";
    public static final String ES_TYPE_FOR_INDEX_RESULT_INFO = "risk_index_result_info";

    //index change
    public static final String REDIS_KEY_INDEX = "RISK_INDEX_BUF";
    //风险成功执行的平均时间间隔
    public static final  String REDIS_AVG_EXEC_SESSIONS="MODEL_AVG_EXEC_SESSIONS_TIME";
    ...
    //风险指标采集方式，10为sql计算
    public static final int SQL_CALCULATE = 10; 
    //告警通知方法立即通知
    public static final String DAILY_INTERVAL_CONFIG_NOW = "10";
    //告警通知方法按日采集
    public static final String DAILY_INTERVAL_CONFIG_ALERT = "11";
    //告警通知方法按小时采集
    public static final String HOURLY_INTERVAL_CONFIG_ALERT = "12";
    //告警通知方法通知对象类型:用户类型
    public static final int USER_TYPE = 10;
    //告警通知方法通知对象类型:角色类型
    public static final int ROLE_TYPE = 11;
    //告警通知方法通知对象类型:系统外用户
    public static final int OUT_SYS_TYPE = 13;
    
    //mongo imei明细存储库以及集合
	public static final String MONGODB_BRM_MIGU_DETAILS = "BRM_EVD_0515";
	public static final String MONGODB_COLLECTION_FAKEUSER_VISIT = "risk_detail_fake_user_visit";
	
	public static final String TOPIC_CLUSTER_REQ = "TOPIC_CLUSTER_REQ";
	
	//mongodb数据源ID
	public static final String MONGODB_DATASOURCE_ID = "000006";
	//Elastic ID
	public static final String ES_DATASOURCE_ID = "000007";
}