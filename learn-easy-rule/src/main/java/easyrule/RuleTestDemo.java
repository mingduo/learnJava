...
import easyrule.ruleegine.IndexExpression;
...
public class RuleTestDemo {
    ...
    public static void testRules2() throws Exception {
    ...
    public static void testRules3() throws Exception {
