 ...
 * <p>
 */
public class One2NMainHistoryDataEventProcessor extends AbstractEventProcessor implements DataSourceFetcherAware {

    private static final Logger logger = LoggerFactory.getLogger(One2NMainHistoryDataEventProcessor.class);

    private static final String ORG_ID = "virtual_id_org";
    ...
    private void removeVirtualColums(EventData eventData) {
        eventData.getColumns().removeIf(e->e.getIndex()>1);
    }
